# knowledge-incorporation/src/query/CPT_mlx.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--dataset", default="knowledge-incorporation/mlx_experiments/data/synthetic_data/eval/base_val.json")
    p.add_argument("--output_dir", default="knowledge-incorporation/mlx_experiments/results/cpt")
